...
title('Suspension Deflection Response with Different Damping Coefficients')
...
text(0.2, 0.002, 'Low frequency: suspension follows road profile', 'FontSize', 8)
text(50, 0.05, 'High damping reduces peak deflection', 'FontSize', 8)
text(2, 5, 'Low damping: large suspension travel', 'FontSize', 8)